...
const FacilitiesSection = () => {
  const facilities = [
    ...
    },
    {
      ...
      description: "Ruang khusus dengan peralatan audio visual untuk pembelajaran"
    },
    {
      icon: Wifi,
    ...
    },
    {
      ...
      description: "Sistem penyimpanan buku yang terorganisir dan mudah diakses"
    },
    {
      icon: Coffee,
          ...
          {facilities.map((facility, index) => (
            ...
            >
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-card hover:shadow-hover transition-all duration-300 hover:-translate-y-2 border border-white/50">
                ...
                <h3 className="text-xl font-semibold text-navy-soft mb-4 text-center group-hover:text-navy-light transition-colors">
                  {facility.title}
                </h3>
