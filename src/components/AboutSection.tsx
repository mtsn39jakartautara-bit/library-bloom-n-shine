  ...
  const features = [
    {
      ...
      description: "Ribuan buku dari berbagai kategori untuk mendukung pembelajaran"
    },
    {
      icon: Users,
      title: "Layanan Prima",
      description: "Tim pustakawan profesional siap membantu kebutuhan literasi Anda"
    },
    {
      icon: Heart,
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-warm-gray max-w-3xl mx-auto leading-relaxed">
            Perpustakaan MTsN 39 adalah pusat literasi yang menyediakan berbagai koleksi buku, 
            layanan informasi, dan ruang baca yang nyaman bagi siswa dan guru. Kami berkomitmen 
            untuk menciptakan lingkungan pembelajaran yang inspiratif dan mendukung.
          </p>
        </motion.div>
            ...
            <motion.div key={index} variants={itemVariants}>
              <Card className="h-full shadow-card hover:shadow-hover transition-all duration-300 hover:-translate-y-2 bg-gradient-card border-0">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="text-xl font-semibold text-navy-soft mb-3">
                    {feature.title}
                  </h3>
