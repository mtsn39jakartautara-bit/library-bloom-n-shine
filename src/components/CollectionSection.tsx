  ...
  const collections = [
    {
      ...
      description: "Koleksi lengkap buku mata pelajaran sesuai kurikulum terbaru",
      color: "bg-blue-100 text-blue-600"
    },
    {
      icon: Sparkles,
      title: "Buku Fiksi",
      description: "Novel, cerpen, dan karya sastra untuk mengembangkan imajinasi",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-warm-gray max-w-2xl mx-auto">
            Temukan beragam koleksi dan layanan yang kami sediakan untuk mendukung 
            perjalanan literasi dan pembelajaran Anda.
          </p>
        </motion.div>
            ...
            >
              <Card className="h-full shadow-card hover:shadow-hover transition-all duration-300 bg-gradient-card border-0 group cursor-pointer">
                <CardContent className="p-8 text-center">
                  ...
                  <h3 className="text-xl font-semibold text-navy-soft mb-4 group-hover:text-navy-light transition-colors">
                    {item.title}
                  </h3>
